package org.den.projectmvc.controller.admin;
...
import org.den.projectmvc.services.admin.AdminDepartmentService;
...
public class AdminDepartmentController {
    ...
    public String showDepartmentActions(Model model) {
        model.addAttribute("departments", adminDepartmentService.findAll());
        return "department/departmentActions";
    }
    @GetMapping("/findAll")
    public String findAllDepartments(Model model) {
        List<Department> departments = adminDepartmentService.findAll();
    ...
    public String showCreateForm(Model model) {
        ...
        return "department/departmentCreation";
    }
    @GetMapping("/find/{id}")
    ...
    public String createDepartment(@ModelAttribute DepartmentRequest departmentRequest, RedirectAttributes redirectAttributes) {
        ...
        System.out.println(departmentRequest.getUserIds());
        adminDepartmentService.create(department);

        departmentRequest.getUserIds().forEach(userId -> {
            adminDepartmentService.assignUserToDepartment(userId, department.getId());
        });
